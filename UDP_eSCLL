...
sock.bind(('10.10.10.4', 7771))  # Match to your device
...
command('AX') #Reset the Alarms
command('ME') # Enable the motor
command('DI1') # Define direction
time.sleep(.1)
command('JS1') # Jogging speed 1
time.sleep(.1)
command('CJ') # Command jogging
time.sleep(5)
command('SJ') # Stop jogging
time.sleep(.1)
command('DI-1')
time.sleep(.1)
command('CJ')
